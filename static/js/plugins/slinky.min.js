    ...
    var a = function () {
        ...
        return s(e, [{
            ...
            key: "_init", value: function (e) {
                ...
                var t = this.menu, n = this.settings;
            ...
            key: "_addListeners", value: function () {
                var e = this, t = this.menu, n = this.settings;
            ...
            key: "_jumpToInitial", value: function () {
                var e = this.menu, t = this.settings, n = e.find(".active");
            ...
            key: "_move", value: function () {
                ...
                if (0 !== e) {
                    var n = this.settings, i = this.base, r = Math.round(parseInt(i.get(0).style.left)) || 0;
                    i.css("left", "".concat(r - 100 * e, "%")), "function" == typeof t && setTimeout(t, n.speed)
                }
            }
        }, {
            key: "_resize", value: function (e) {
                this.menu.height(e.outerHeight())
            }
        }, {
            key: "_transition", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 300, t = this.menu,
                    n = this.base;
                t.css("transition-duration", "".concat(e, "ms")), n.css("transition-duration", "".concat(e, "ms"))
            }
        }, {
            key: "jump", value: function (e) {
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                if (e) {
                    var n = this.menu, i = this.settings, r = jQuery(e), s = n.find(".active"), a = 0;
            ...
            key: "home", value: function () {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = this.base,
                    n = this.menu, i = this.settings;
                e || this._transition(0);
                var r = n.find(".active"), s = r.parentsUntil(n, "ul");
            ...
            key: "destroy", value: function () {
                var e = this, t = this.base, n = this.menu;
